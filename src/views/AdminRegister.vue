    ...
    <div class="registerPage">
      ...
      <div class="registerBox" v-loading="isRegistering">
        ...
        <form>
          ...
          <!-- 管理员界面新增联络管理员id -->
          <div>
            <label for="contactAdminId">联络的管理员ID:</label>
            <el-input v-model="contactAdminId" id="contactAdminId" type="text" />
          </div>
          <label for="type">选择注册管理员类型:</label>
          <el-radio-group v-model="selectedOption">
            <el-row>
              ...
              <el-col :span="6">
                <el-radio-button value="venue">场地</el-radio-button>
              </el-col>
              <el-col :span="6">
...
import { adminRegister, getAllVenues } from '@/apis/requests';
