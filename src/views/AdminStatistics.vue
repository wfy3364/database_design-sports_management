...
const reserveDataList = {
  ...
  monthly: {
    ...
    data: [13, 14, 16, 15, 13, 7, 10, 13, 10, 5, 12, 3, 15, 27, 16, 13, 14, 16, 15, 13, 7, 10, 13, 10, 5, 12, 3, 15, 27, 16],
  },
  yearly: {
    labels: ['2023-09', '2023-10', '2023-11', '2023-12', '2024-01', '2024-02', '2024-03', '2024-04', '2024-05', '2024-06', '2024-07', '2024-08'],
    data: [390, 170, 315, 141, 522, 380, 330, 270, 160, 430, 320, 390],
  }
};
...
const revenueDataList = {
  daily: {
    labels: ['08-01', '08-02', '08-03', '08-04', '08-05', '08-06', '08-07'],
    data: [220, 200, 160, 100, 240, 120, 460, 300, 160],
  },
  monthly: {
    labels: ['07-27', '07-28', '07-29', '07-30', '07-31', '08-01', '08-02', '08-03', '08-04', '08-05', '08-06', '08-07', '08-08', '08-09', '08-10', '08-11', '08-12', '08-13', '08-14', '08-15', '08-16', '08-17', '08-18', '08-19', '08-20', '08-21', '08-22', '08-23', '08-24', '08-25'],
    data: [260, 280, 320, 300, 260, 140, 200, 260, 200, 100, 240, 60, 310, 540, 320, 260, 280, 320, 300, 260, 140, 200, 260, 200, 100, 240, 60, 310, 540, 320],
  },
  yearly: {
    labels: ['2023-09', '2023-10', '2023-11', '2023-12', '2024-01', '2024-02', '2024-03', '2024-04', '2024-05', '2024-06', '2024-07', '2024-08'],
    data: [7800, 3400, 6300, 2800, 10440, 7600, 6600, 5400, 3200, 8600, 6400, 7800],
  }
};
